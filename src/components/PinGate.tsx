      ...
      <div className="relative max-w-4xl w-full grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 bg-slate-900 border border-slate-800 rounded-3xl p-4 md:p-10 shadow-2xl mt-4 md:mt-0 mb-8 md:mb-0">
        ...
        <div className="md:col-span-5 flex flex-col justify-between space-y-4 md:space-y-8 z-10">
          <div className="space-y-2 md:space-y-4">
            ...
            <p className="hidden md:block text-xs text-slate-400 leading-relaxed font-sans pt-2">
          ...
          <div className="space-y-2 md:space-y-3">
            <div className="text-[10px] md:text-[11px] font-sans font-bold text-slate-400 tracking-wider uppercase flex items-center gap-1.5 pb-0.5 md:pb-1">
        ...
        <div className="md:col-span-7 flex flex-col justify-center items-center bg-slate-950/60 rounded-2xl border border-slate-850 p-4 md:p-6 z-10 space-y-3 md:space-y-4">
          ...
          {pinError ? (
            <span className="text-[10px] md:text-xs text-rose-450 font-bold text-rose-400 bg-rose-950/30 px-3 py-1.5 rounded-lg border border-rose-900/40 animate-pulse text-center">
              Invalid passcode entered. Please retry!
            </span>
          ) : (
            <span className="text-[9px] md:text-[10px] text-slate-500 font-mono italic text-center">
